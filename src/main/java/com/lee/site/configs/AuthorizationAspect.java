...
import com.lee.site.exception.AuthorizationHeaderNotExistsException;
import com.lee.site.exception.InvalidTokenException;
import com.lee.site.exception.TokenExpiredException;
...
public class AuthorizationAspect {
	...
	@Before("execution(public * com.lee.site.controllers.api.v1..*Controller.*(..)) ")
